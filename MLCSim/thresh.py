...
def main():
    ...
    parser.add_argument('-e', type=float, default='0.04', help='Threshold stdev for 2 bits per cell')
    parser.add_argument('-f', help='Threshold map json to output')
    parser.add_argument('--plot', action='store_true')
    parser.add_argument('--scale-e', action='store_true', help='Scale -e with MLC size to preserve overlap')
